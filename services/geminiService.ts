...
export class GeminiService {
  ...
  async analyzeReviews(businessName: string, reviews: Review[], knownServices: string[], tier: Tier): Promise<AnalysisResult> {
    ...
    const prompt = `
      ...
      RULES:
      1. 'services': MUST be tangible items that customers buy or book (e.g., "Espresso", "Implants", "Oil Change").
         - NEGATIVE CONSTRAINT: Do NOT use abstract words like "Service", "Quality", "Experience", "Professionalism", "Staff" here. 
      ...
      2. 'loves': This is where abstract qualities and vibes belong (e.g., "Friendly Staff", "Clean Atmosphere", "Great Vibe", "Fast Service").
          ...
          responseSchema: {
            ...
            properties: {
              ...
              services: { 
                ...
                description: "Top 3-5 TANGIBLE services/products. Return fewer if data is weak."
              },
              loves: { 
                type: Type.ARRAY, 
                items: { type: Type.STRING },
                description: "Top 3-5 attributes/vibes. Return fewer if data is weak."
              }
            },
